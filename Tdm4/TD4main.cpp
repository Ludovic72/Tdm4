...
int main(){
	...
	std::cout << "***********Ensemble d'instructions B2****************" << std::endl;
	std::cout << "Value :" << m1[2][1] << std::endl;
	m2[4][2] = 7;
	...
	std::cout << "***********Ensemble d'instructions C2****************" << std::endl;
	m3 = m1;
	std::cout << m3 << std::endl;
	std::cout << "Egalite: " << (m1 == m3) << std::endl;
	m3[2][3] = 10;
	std::cout << "Value :" << m1[2][3] << std::endl;
	std::cout << m3 << std::endl;
	std::cout << "Different: " << (m3 != m1) << std::endl;
	std::cout << "Egalite: " << (m1 == m2) << std::endl;
	std::cout << "Different: " << (m2 != m1) << std::endl;
	std::cout << std::endl;

	std::cout << "***********Ensemble d'instructions D2****************" << std::endl;
	m3 = m3 * 2;
	std::cout << m3 << std::endl;
	m4 = m1 + m3;
